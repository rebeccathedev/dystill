...
# me@rebeccapeck.org. dystill will parse this out to me@rebeccapeck.org and 
# deliver to the appropriate mailbox, but with me@rebeccapeck.org still
# in the To: field.
delimiter=-
...
```sql
insert into filters set me@rebeccapeck.org', field='X-Spam-Flag', 
